...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <!--tela principal-->
            <div class="col main-t no-scroll">

                <div class="a-post amainp text-center">
                    <h1>Suas metas atuais: </h1>
                    
                    <div class=" scrollable contmeta">
                        <?php
                            include "metasconfig.php";
                        ?>
                ...
                <form action="metains.php" method="post">
                    <div class="inp-msg">
                        <input type="text" name="ameta" class="input-msg" autocomplete="off">
                        <button type="submit" class="subm-msg"><ion-icon name="send"></ion-icon></button>
                    </div>
                </form>
            </div>
...
<script src="https://unpkg.com/ionicons@4.5.10-0/dist/ionicons.js"></script> <!-- importa icones brabos -->
</html>